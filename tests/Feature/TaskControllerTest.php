...
class TaskControllerTest extends TestCase
{
    ...
    public function test_retrieve_tasks_with_options()
    {
        ...
        $response = $this->get('/api/tasks?filter[is_done]=true&sort=-created_at&page=2');
    ...
    public function test_create_new_task_successfully()
    {
        ...
        // Act
        $response = $this->post('/api/tasks', $request->all());
    ...
    public function test_update_existing_task_successfully()
    {
        ...
        $response = $this->put('/api/tasks/' . $task->id, ['title' => $updatedTitle]);
    ...
    {
        $response = $this->get('/api/tasks?is_done=invalid');
    ...
    {
        $response = $this->get('/api/tasks?sort=invalid');
    ...
    {
        $response = $this->get('/api/tasks?page=abc');
    ...
    {
        $response = $this->get('/api/tasks/9999');
    ...
    public function test_create_new_task_with_invalid_data()
    {
        ...
        // Act
        $response = $this->post('/api/tasks', $request->toArray());
    ...
    public function test_deleting_non_existent_task()
    {
        ...
        // Delete the task
        $response = $this->delete('/api/tasks/' . ($task->id + 1));
    ...
    public function test_creating_task_with_invalid_data()
    {
        ...
        // Act
        $response = $this->post('/api/tasks', $requestData);
    ...
    {
        $pageSize = 10;
        $request = Request::create('/api/tasks', 'GET', ['page_size' => $pageSize]);
        $controller = new TaskController();
        $response = $controller->index($request);
        $tasks = $response->getData()->data;
    ...
    public function test_filtering_with_multiple_filter_values()
    {
        ...
        $response = $this->get('/api/tasks?filter[is_done]=true,false');
    ...
    public function test_sorting_with_multiple_sort_values()
    {
        ...
        $response = $this->get('/api/tasks?sort=created_at,-title');
